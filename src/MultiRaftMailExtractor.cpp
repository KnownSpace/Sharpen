...
sharpen::MultiRaftMailExtractor::NviExtractPrevoteRequest(
    const sharpen::Mail &mail) const noexcept {
...
sharpen::MultiRaftMailExtractor::NviExtractPrevoteResponse(
    const sharpen::Mail &mail) const noexcept {
...
sharpen::MultiRaftMailExtractor::NviExtractSnapshotRequest(
    const sharpen::Mail &mail) const noexcept {
