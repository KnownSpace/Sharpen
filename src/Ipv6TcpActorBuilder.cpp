...
sharpen::Ipv6TcpActorBuilder::Ipv6TcpActorBuilder(bool pipeline,sharpen::IFiberScheduler &scheduler,sharpen::IEventLoopGroup &loopGroup)
    :remote_()
...
sharpen::Ipv6TcpActorBuilder::Ipv6TcpActorBuilder(const sharpen::Ipv6EndPoint &local,bool pipeline,sharpen::IFiberScheduler &scheduler,sharpen::IEventLoopGroup &loopGroup)
    :remote_()
    ,scheduler_(&scheduler)
    ,factory_(nullptr)
    ,receiver_(nullptr)
