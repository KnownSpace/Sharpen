...
sharpen::UniquedTimerRef::UniquedTimerRef(sharpen::TimerPtr &&timer,
                                          sharpen::ITimerPool &pool) noexcept
    : pool_(&pool)
...
sharpen::SharedTimerRef::SharedTimerRef(sharpen::TimerPtr &&timer,
                                        sharpen::ITimerPool &pool) noexcept
