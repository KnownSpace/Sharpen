...
void sharpen::TcpActor::DoPost(const sharpen::Mail *mail) noexcept
{
    assert(mail);
...
void sharpen::TcpActor::Post(const sharpen::Mail &mail)
{
    this->worker_->Submit(&Self::DoPost,this,&mail);
}
