    ...
    ,offset_(0)
{
    ...
    sharpen::FileChannelPtr channel{sharpen::OpenFileChannel(this->name_.c_str(),sharpen::FileAccessMethod::All,sharpen::FileOpenMethod::CreateOrOpen,sharpen::FileIoMethod::Sync)};
...
sharpen::Optional<sharpen::ByteBuffer> sharpen::WalStatusMap::NviLookup(const sharpen::ByteBuffer &key) const
{
    {
        this->lock_->LockRead();
        std::unique_lock<sharpen::AsyncRwLock> lock{*this->lock_,std::adopt_lock};
