...
sharpen::MultiRaftMailBuilder::MultiRaftMailBuilder(std::uint32_t magic,std::uint32_t raftNumber) noexcept
    :magic_(magic)
...
sharpen::MultiRaftForm sharpen::MultiRaftMailBuilder::BuildForm(sharpen::RaftMailType type,const sharpen::ByteBuffer &content) const noexcept
{
...
sharpen::Mail sharpen::MultiRaftMailBuilder::BuildVoteResponse(const sharpen::RaftVoteForResponse &response) const
{
...
sharpen::Mail sharpen::MultiRaftMailBuilder::BuildPrevoteRequest(const sharpen::RaftPrevoteRequest &request) const
{
    std::uint32_t size{sharpen::IntCast<std::uint32_t>(request.ComputeSize())};
    sharpen::ByteBuffer content{size};
    sharpen::BufferWriter writer{content};
...
sharpen::Mail sharpen::MultiRaftMailBuilder::BuildPrevoteResponse(const sharpen::RaftPrevoteResponse &response) const
{
    std::uint32_t size{sharpen::IntCast<std::uint32_t>(response.ComputeSize())};
    sharpen::ByteBuffer content{size};
    sharpen::BufferWriter writer{content};
...
sharpen::Mail sharpen::MultiRaftMailBuilder::BuildHeartbeatRequest(const sharpen::RaftHeartbeatRequest &request) const
{
    std::uint32_t size{sharpen::IntCast<std::uint32_t>(request.ComputeSize())};
    sharpen::ByteBuffer content{size};
    sharpen::BufferWriter writer{content};
...
sharpen::Mail sharpen::MultiRaftMailBuilder::BuildHeartbeatResponse(const sharpen::RaftHeartbeatResponse &response) const
{
    std::uint32_t size{sharpen::IntCast<std::uint32_t>(response.ComputeSize())};
    sharpen::ByteBuffer content{size};
    sharpen::BufferWriter writer{content};
...
sharpen::Mail sharpen::MultiRaftMailBuilder::BuildSnapshotRequest(const sharpen::RaftSnapshotRequest &request) const
{
    std::uint32_t size{sharpen::IntCast<std::uint32_t>(request.ComputeSize())};
    sharpen::ByteBuffer content{size};
    sharpen::BufferWriter writer{content};
...
sharpen::Mail sharpen::MultiRaftMailBuilder::BuildSnapshotResponse(const sharpen::RaftSnapshotResponse &response) const
{
    std::uint32_t size{sharpen::IntCast<std::uint32_t>(response.ComputeSize())};
    sharpen::ByteBuffer content{size};
    sharpen::BufferWriter writer{content};
