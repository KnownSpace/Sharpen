...
void sharpen::LinuxSignalFdChannel::DoSafeClose(sharpen::ErrorCode err,sharpen::ChannelPtr keepalive) noexcept
{
    (void)keepalive;
...
void sharpen::LinuxSignalFdChannel::CompleteReadCallback(sharpen::EventLoop *loop,sharpen::Future<std::size_t> *future,ssize_t size) noexcept
{
    if(size == -1)
    {
...
void sharpen::LinuxSignalFdChannel::RequestRead(char *buf,std::size_t bufSize,sharpen::Future<std::size_t> *future)
{
...
void sharpen::LinuxSignalFdChannel::ReadAsync(sharpen::SignalBuffer &signals,sharpen::Future<std::size_t> &future)
{
