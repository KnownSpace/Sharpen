...
std::size_t sharpen::IAsyncRandomReadable::ReadAsync(char *buf,std::size_t bufSize,std::uint64_t offset)
{
...
std::size_t sharpen::IAsyncRandomReadable::ReadAsync(sharpen::ByteBuffer &buf,std::size_t bufferOffset,std::uint64_t offset)
{
    sharpen::AwaitableFuture<std::size_t> future;
