...
namespace sharpen
{
    ...
    class RemotePosterOpenError:public InternalRemotePosterOpenError<std::exception,sizeof(std::exception) == sizeof(void*)>
    {
    private:
        using Self = RemotePosterOpenError;
        using Base = InternalRemotePosterOpenError<std::exception,sizeof(std::exception) == sizeof(void*)>;
    public:
