...
namespace sharpen
{
    ...
    //Base64 Encode
    extern  bool Base64Encode(char *dst, std::size_t dstSize, const char *src, std::size_t srcSize) noexcept;

    //Base64 Decode Mapping
    extern  char Base64DecodeMapping(unsigned char c) noexcept;

    //Base64 Decode
    extern bool Base64Decode(char *dst, std::size_t dstSize, const char *src, std::size_t srcSize) noexcept;
    ...
    extern std::int32_t BufferCompare(const char *leftBuf,std::size_t leftSize,const char *rightBuf,std::size_t rightSize) noexcept;
}
