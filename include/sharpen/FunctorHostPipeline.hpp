...
namespace sharpen
{
    class FunctorHostPipeline:public sharpen::IHostPipeline,public sharpen::Noncopyable,public sharpen::Nonmovable
    {
    private:
        using Self = FunctorHostPipeline;
        using Base = sharpen::IHostPipeline;
        using Functor = std::function<sharpen::HostPipelineResult(sharpen::INetStreamChannel&,const std::atomic_bool&)>;
