...
namespace sharpen
{
    ...
    class MailParseError:public InternalMailParseError<std::exception,sizeof(std::exception) == sizeof(void*)>
    {
    private:
        using Self = sharpen::MailParseError;
        using Base = sharpen::InternalMailParseError<std::exception,sizeof(std::exception) == sizeof(void*)>;
    public:
