...
namespace sharpen
{
    ...
    class CorruptedDataError:public sharpen::InternalCorruptedDataError<std::exception,sizeof(std::exception) == sizeof(void*)>
    {
    private:
        using Self = sharpen::CorruptedDataError;
        using Base = sharpen::InternalCorruptedDataError<std::exception,sizeof(std::exception) == sizeof(void*)>;
    public:
