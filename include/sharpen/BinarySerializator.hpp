...
namespace sharpen {
    ...
    private:
        ...
        template<
            ...
            typename _Check =
                decltype(std::declval<std::size_t &>() =
                             Self::InternalComputeSize(std::declval<const _T1 &>(), 0, 0, 0, 0) +
                             Self::InternalComputeSize(std::declval<const _T2 &>(), 0, 0, 0, 0))>
        ...
        template<typename _T,
                 typename _Check = decltype(std::declval<std::size_t &>() =
                                                Self::InternalLoadFrom(std::declval<_T &>(),
                                                                       nullptr,
        ...
        template<typename _T1,
                 typename _T2,
                 typename _Check = decltype(std::declval<std::size_t &>() =
                                                Self::InternalLoadFrom(std::declval<_T1 &>(),
                                                                       nullptr,
                                                                       static_cast<std::size_t>(0),
                                                                       0,
                                                                       0,
                                                                       0,
                                                                       0) +
                                                Self::InternalLoadFrom(std::declval<_T2 &>(),
                                                                       nullptr,
                                                                       static_cast<std::size_t>(0),
                                                                       0,
                                                                       0,
        ...
        template<typename _Container,
                 typename _Check = decltype(Self::InternalLoadFrom(
                     *sharpen::Begin(std::declval<_Container &>())++,
                     nullptr,
                     static_cast<std::size_t>(0),
                     0,
                     0,
        ...
        static std::size_t InternalLoadFrom(
            ...
            using ValueType =
                typename std::remove_reference<decltype(*sharpen::Begin(container))>::type;
        ...
        template<
            typename _T,
            typename _Check = decltype(std::declval<std::size_t &>() = Self::InternalUnsafeStoreTo(
        ...
        template<
            ...
            typename _Check = decltype(std::declval<std::size_t &>() =
                                           Self::InternalUnsafeStoreTo(
                                               std::declval<const _T1 &>(), nullptr, 0, 0, 0, 0) +
                                           Self::InternalUnsafeStoreTo(
