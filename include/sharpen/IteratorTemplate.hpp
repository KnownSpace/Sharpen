...
namespace sharpen
{
    template<typename _IteratorCategory,typename _ValueType,typename _DistanceType,typename _PointerType,typename _ReferenceType>
    ...
    using DefaultIteratorTemplate = sharpen::IteratorTemplate<_IteratorCategory,_T,std::ptrdiff_t,_T*,_T&>; 
}
