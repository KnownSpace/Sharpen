...
namespace sharpen
{
    ...
    public:
        ...
        template<typename _T,typename _Check = decltype(sharpen::BinarySerializator::UnsafeStoreTo(std::declval<const _T&>(),nullptr),sharpen::BinarySerializator::ComputeSize(std::declval<const _T&>()))>
