...
namespace sharpen
{
    ...
    public:
        ...
        template<typename _Fn,typename _Check = decltype(std::declval<sharpen::UncheckedTruvialFunctionPtr<_Ret,_Args...>&>() = sharpen::UncheckedTrivialFunction(std::declval<_Fn&>()))>
