...
namespace sharpen
{
    class ConsoleHostLifetime:public sharpen::IHostLifetime,public sharpen::Noncopyable
    {
    private:
    ...
    public:
        ...
        ConsoleHostLifetime(sharpen::IFiberScheduler &scheduler,sharpen::IEventLoopGroup &loopGroup);
