...
namespace sharpen
{
    ...
    {
        template<typename _Fn,typename ..._Args,typename _Check = decltype(_T{std::declval<_Fn>()(std::declval<_Args>()...)})>
    ...
    {
        template<typename _Fn,typename ..._Args,typename _Check = decltype(std::declval<_Fn>()(std::declval<_Args>()...))>
