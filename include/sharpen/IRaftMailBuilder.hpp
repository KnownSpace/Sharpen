...
namespace sharpen
{
    ...
    public:
        ...
        virtual sharpen::Mail BuildSnapshotRequest(const sharpen::RaftSnapshotRequest &request) const = 0;

        virtual sharpen::Mail BuildSnapshotResponse(const sharpen::RaftSnapshotResponse &response) const = 0;
    };
}
